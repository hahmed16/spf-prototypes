...
const APPEALS_DATA = [
  ...
  },
  {
    ...
    originalRequestType: 'عرض على المؤسسات الصحية المرخصة',
    ...
    notes: [],
    timeline: [
      { action: 'تم تقديم التظلم', actor: 'خالد بن سعيد البلوشي', role: 'الشخص المفوض من جهة العمل', time: '2025-01-27 09:15', fromStatus: '', toStatus: 'تم تقديم طلب التظلم — بانتظار مراجعة موظف قسم اللجان الطبية', note: 'تم إنشاء التظلم على قرار مرتبط بطلب عرض على المؤسسات الصحية المرخصة', type: 'default' },
