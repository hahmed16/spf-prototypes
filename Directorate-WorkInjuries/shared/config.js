...
const WI_CONFIG = {
  ...
  */
  ...
  statusBadges: {
    ...
    'تم تقديم طلب العرض المباشر — بانتظار مراجعة منسق الإحالات والتحويلات': 'b-submitted',
  ...
  roleStages: {
    ...
    'direct-referral-employee': ['تم تقديم طلب العرض المباشر — بانتظار مراجعة موظف طلبات العرض المباشر', 'قيد مراجعة موظف طلبات العرض المباشر', 'معلّق مؤقتاً — بانتظار الاستئناف'],
    'referral-coordinator': ['تم تقديم طلب العرض المباشر — بانتظار مراجعة منسق الإحالات والتحويلات', 'قيد مراجعة منسق الإحالات والتحويلات', 'تم طلب العرض على المؤسسات الصحية المرخصة — بانتظار مراجعة منسق الإحالات والتحويلات', 'قيد المتابعة لدى منسق الإحالات والتحويلات', 'تمت متابعة الحالة مع المؤسسة الصحية — بانتظار انعقاد الجلسة', 'تم استلام قرار المؤسسة الصحية — بانتظار استكمال التنفيذ', 'معلّق مؤقتاً — بانتظار الاستئناف'],
  }
};
