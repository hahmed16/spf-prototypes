...
const WI_DATA = {
  ...
  allowances: [
    ...
    },
    {
      ...
      type: 'إعاقة',
      subtype: 'إعاقة حركية',
      status: 'بانتظار مراجعة موظف قسم اللجان الطبية',
      submitDate: '2025-03-01',
      lastUpdate: '2025-03-05 09:30',
      applicant: { name: 'طارق بن سالم العبري', civil: '9023344556', role: 'العامل / المؤمن عليه / المواطن', phone: '96892334455', email: 'tariq.a@mail.com' },
      insured: { name: 'طارق بن سالم العبري', civil: '9023344556', insurance: 'IN-20140023344', dob: '1980-02-20', gender: 'ذكر', nationality: 'عُماني', insuranceStatus: 'نشط', regDate: '2014-06-01', subType: 'إلزامي' },
      employer: { name: 'شركة الخليج للاستشارات الهندسية', cr: '3344556', establishment: 'EST-0044556', jobTitle: 'مهندس مدني', joinDate: '2014-06-01', location: 'مسقط — روي' },
      card: { number: 'DIS-CARD-0021133', status: 'سارية', activationDate: '2022-06-15', expiryDate: '2027-06-14', typeSD: 'إعاقة حركية — الأطراف العلوية', typeMOH: 'بتر الطرف العلوي الأيمن', provenDate: '2022-05-20', lastCheck: '2025-02-15' },
      investigation: {
        employeeName: 'نورة بنت سالم الزدجالية',
        employeeDate: '2025-02-25 10:00',
        employeeRecommendation: 'موافقة',
        employeeNotes: 'تم التحقق من صحة بطاقة الإعاقة وصلاحيتها. الحالة مستوفية للشروط وتستحق العرض على المؤسسة الصحية لتحديد نسبة العجز المهني.',
        headName: 'بدر بن خميس العبري',
        headDate: '2025-03-04 14:00',
        headDecision: 'اعتماد وإحالة',
        headNotes: 'تمت مراجعة التوصية. أوافق على الإحالة للجان الطبية لتقييم نسبة العجز الدائم.',
      },
      attachments: [
        { id: 'com401-1', type: 'صورة بطاقة الإعاقة', name: 'بطاقة_اعاقة_401.pdf', uploadDate: '2025-03-01', uploadedBy: 'طارق بن سالم العبري', role: 'العامل', size: '0.9 MB', icon: 'pdf' },
        { id: 'com401-2', type: 'تقرير طبي', name: 'تقرير_طبي_401.pdf', uploadDate: '2025-03-01', uploadedBy: 'طارق بن سالم العبري', role: 'العامل', size: '1.5 MB', icon: 'pdf' },
      ],
      notes: [],
      sickLeavePeriods: [],
      referral: null, session: null, committeeDecision: null, disbursement: null,
      timeline: [
        { action: 'تم تقديم الطلب', actor: 'طارق بن سالم العبري', role: 'العامل', time: '2025-03-01 09:00', fromStatus: '', toStatus: 'قيد المراجعة', note: '', type: 'default' },
        { action: 'توصية الموظف بالموافقة', actor: 'نورة بنت سالم الزدجالية', role: 'موظف قسم الإعاقة والأمراض المستديمة', time: '2025-02-25 10:00', fromStatus: 'قيد المراجعة', toStatus: 'بانتظار اعتماد رئيس قسم الإعاقة', note: 'التوصية: موافقة', type: 'success' },
        { action: 'اعتماد وإحالة للجان الطبية', actor: 'بدر بن خميس العبري', role: 'رئيس قسم الإعاقة والأمراض المستديمة', time: '2025-03-04 14:00', fromStatus: 'بانتظار اعتماد رئيس القسم', toStatus: 'بانتظار مراجعة موظف قسم اللجان الطبية', note: '', type: 'success' },
      ],
      assignedTo: 'سعاد بنت أحمد الريامية',
      checkedOutBy: 'سعاد بنت أحمد الريامية',
    },
    {
      ...
      lastUpdate: '2025-03-09 11:15',
      applicant: { name: 'هناء بنت خلفان البلوشية', civil: '9044556677', role: 'العامل / المؤمن عليه / المواطن', phone: '96894455667', email: 'hana.b@mail.com' },
      insured: { name: 'هناء بنت خلفان البلوشية', civil: '9044556677', insurance: 'IN-20160044556', dob: '1976-07-12', gender: 'أنثى', nationality: 'عُمانية', insuranceStatus: 'نشط', regDate: '2016-01-01', subType: 'إلزامي' },
      employer: { name: 'مستشفى الرحمة الخاصة', cr: '5566779', establishment: 'EST-0055667', jobTitle: 'ممرضة رئيسية', joinDate: '2016-01-01', location: 'مسقط — الخوير' },
      chronic: {
        uniqueRequestId: 'MOH-CHR-2025-00201',
        hospital: 'مستشفى السلطاني — مسقط',
        doctor: 'د. سالم بن حمد الحارثي',
        chronicDisease: 'داء السكري من النوع الثاني',
        affectedSystem: 'الغدد الصماء',
        provenDate: '2024-09-10',
        severityDate: '2024-10-01',
        severityIndex: 'MSI: 2/5 — Treatment Burden: متوسط',
        permanentDiseaseReport: 'تم تشخيص داء السكري من النوع الثاني مع مضاعفات مزمنة في الكلى والشبكية. أظهرت الفحوصات المخبرية ارتفاع مستمر في مستويات السكر مع حاجة دائمة للعلاج الدوائي والمتابعة الدورية.',
      },
      investigation: {
        employeeName: 'نورة بنت سالم الزدجالية',
        employeeDate: '2025-03-07 09:00',
        employeeRecommendation: 'موافقة',
        employeeNotes: 'تم التحقق من التشخيص الطبي الوارد من وزارة الصحة وصحة الوثائق المرفقة. الحالة مستوفية للشروط وتستحق العرض على اللجنة الطبية المتخصصة لتحديد مدى انعكاس المرض على القدرة المهنية.',
        headName: 'بدر بن خميس العبري',
        headDate: '2025-03-08 15:30',
        headDecision: 'اعتماد وإحالة',
        headNotes: 'الملف مكتمل والتوصية سليمة. تمت الموافقة على الإحالة للجان الطبية.',
      },
      sickLeavePeriods: [
        { from: '2024-10-05', to: '2024-11-04', days: 30, status: 'معتمدة', addedBy: 'مريم بنت سيف الكيومية', addedDate: '2024-10-10', note: 'فترة راحة طبية مقررة بناءً على توصية الطبيب المعالج' },
        { from: '2024-11-05', to: '2024-11-19', days: 15, status: 'معتمدة', addedBy: 'مريم بنت سيف الكيومية', addedDate: '2024-11-06', note: 'امتداد للإجازة بناءً على تدهور الحالة' },
      ],
      attachments: [
        { id: 'com402-1', type: 'تقرير طبي مثبت للمرض المستديم', name: 'تقرير_سكري_402.pdf', uploadDate: '2025-03-05', uploadedBy: 'هناء بنت خلفان البلوشية', role: 'العامل', size: '2.1 MB', icon: 'pdf' },
      ],
      notes: [],
      referral: null, session: null, committeeDecision: null, disbursement: null,
      timeline: [
        { action: 'استلام التشخيص من وزارة الصحة', actor: 'وزارة الصحة', role: 'آلي', time: '2024-09-10 08:00', fromStatus: '', toStatus: 'تم استلام التشخيص', note: '', type: 'default' },
        { action: 'تقديم طلب المنفعة', actor: 'هناء بنت خلفان البلوشية', role: 'العامل', time: '2025-03-05 10:00', fromStatus: 'تم استلام التشخيص', toStatus: 'قيد مراجعة موظف قسم الإعاقة والأمراض المستديمة', note: '', type: 'default' },
        { action: 'توصية الموظف بالموافقة', actor: 'نورة بنت سالم الزدجالية', role: 'موظف قسم الإعاقة والأمراض المستديمة', time: '2025-03-07 09:00', fromStatus: 'قيد المراجعة', toStatus: 'بانتظار اعتماد رئيس قسم الإعاقة', note: 'موافقة وإحالة', type: 'success' },
        { action: 'اعتماد وإحالة للجان الطبية', actor: 'بدر بن خميس العبري', role: 'رئيس قسم الإعاقة والأمراض المستديمة', time: '2025-03-08 15:30', fromStatus: 'بانتظار اعتماد رئيس القسم', toStatus: 'بانتظار مراجعة موظف قسم اللجان الطبية', note: '', type: 'success' },
      ],
      assignedTo: 'سعاد بنت أحمد الريامية',
      checkedOutBy: 'سعاد بنت أحمد الريامية',
    },
    {
      ...
      lastUpdate: '2025-03-12 10:00',
      applicant: { name: 'يوسف بن خالد الصوافي', civil: '9055667788', role: 'العامل / المؤمن عليه / المواطن', phone: '96895566778', email: 'yousef.s@mail.com' },
      insured: { name: 'يوسف بن خالد الصوافي', civil: '9055667788', insurance: 'IN-20180055667', dob: '1983-11-05', gender: 'ذكر', nationality: 'عُماني', insuranceStatus: 'نشط', regDate: '2018-03-01', subType: 'إلزامي' },
      employer: null,
      card: { number: 'DIS-CARD-0033445', status: 'سارية', activationDate: '2021-01-20', expiryDate: '2026-01-19', typeSD: 'إعاقة بصرية — فقدان البصر الكلي في العين اليسرى', typeMOH: 'فقدان البصر أحادي الجانب', provenDate: '2020-12-01', lastCheck: '2025-01-20' },
      investigation: {
        employeeName: 'نورة بنت سالم الزدجالية',
        employeeDate: '2025-03-10 11:00',
        employeeRecommendation: 'موافقة',
        employeeNotes: 'بطاقة الإعاقة سارية وصحيحة. التشخيص مؤكد بفقدان البصر في العين اليسرى بشكل دائم. الطلب مكتمل المستندات ويستحق الإحالة للتقييم الطبي.',
        headName: 'بدر بن خميس العبري',
        headDate: '2025-03-11 09:30',
        headDecision: 'اعتماد وإحالة',
        headNotes: 'الملف مستوفٍ. اعتمدت التوصية وأحلت الطلب للجان الطبية.',
      },
      attachments: [
        { id: 'com403-1', type: 'صورة بطاقة الإعاقة', name: 'بطاقة_اعاقة_403.pdf', uploadDate: '2025-03-08', uploadedBy: 'يوسف بن خالد الصوافي', role: 'العامل', size: '0.7 MB', icon: 'pdf' },
        { id: 'com403-2', type: 'تقرير طبي متخصص', name: 'تقرير_بصري_403.pdf', uploadDate: '2025-03-08', uploadedBy: 'يوسف بن خالد الصوافي', role: 'العامل', size: '1.8 MB', icon: 'pdf' },
      ],
      notes: [],
      sickLeavePeriods: [],
      referral: null, session: null, committeeDecision: null, disbursement: null,
      timeline: [
        { action: 'تم تقديم الطلب', actor: 'يوسف بن خالد الصوافي', role: 'العامل', time: '2025-03-08 09:30', fromStatus: '', toStatus: 'قيد المراجعة', note: '', type: 'default' },
        { action: 'توصية الموظف بالموافقة', actor: 'نورة بنت سالم الزدجالية', role: 'موظف قسم الإعاقة والأمراض المستديمة', time: '2025-03-10 11:00', fromStatus: 'قيد المراجعة', toStatus: 'بانتظار اعتماد رئيس القسم', note: 'موافقة', type: 'success' },
        { action: 'اعتماد وإحالة للجان الطبية', actor: 'بدر بن خميس العبري', role: 'رئيس قسم الإعاقة والأمراض المستديمة', time: '2025-03-11 09:30', fromStatus: 'بانتظار اعتماد رئيس القسم', toStatus: 'بانتظار مراجعة موظف قسم اللجان الطبية', note: '', type: 'success' },
      ],
      assignedTo: 'سعاد بنت أحمد الريامية',
      checkedOutBy: 'سعاد بنت أحمد الريامية',
    },
    {
      id: 'COM-2025-000404',
      type: 'أمراض مستديمة',
      subtype: 'القصور الكلوي المزمن',
      status: 'تم الموافقة على العرض على المؤسسات الصحية المرخصة — بانتظار إحالة المقرر',
      submitDate: '2025-02-20',
      lastUpdate: '2025-03-01 13:00',
      applicant: { name: 'نواف بن سعيد الحراصي', civil: '9066778899', role: 'العامل / المؤمن عليه / المواطن', phone: '96896677889', email: 'nawaf.h@mail.com' },
      insured: { name: 'نواف بن سعيد الحراصي', civil: '9066778899', insurance: 'IN-20120066778', dob: '1973-04-18', gender: 'ذكر', nationality: 'عُماني', insuranceStatus: 'نشط', regDate: '2012-09-01', subType: 'إلزامي' },
      employer: { name: 'شركة التأمين العُمانية', cr: '7788990', establishment: 'EST-0077889', jobTitle: 'محاسب أول', joinDate: '2012-09-01', location: 'مسقط — قرم' },
      chronic: {
        uniqueRequestId: 'MOH-CHR-2025-00188',
        hospital: 'مستشفى الخليج الطبي — صحار',
        doctor: 'د. علي بن محمد الكندي',
        chronicDisease: 'القصور الكلوي المزمن — المرحلة الثالثة',
        affectedSystem: 'الجهاز الكلوي والبولي',
        provenDate: '2024-07-15',
        severityDate: '2024-08-20',
        severityIndex: 'MSI: 3/5 — Treatment Burden: مرتفع',
        permanentDiseaseReport: 'تم تشخيص القصور الكلوي المزمن في المرحلة الثالثة مع تراجع ملحوظ في معدل الترشيح الكبيبي. الحالة تستدعي غسيل كلى دوري ومتابعة أسبوعية مستمرة وتؤثر بشكل مباشر على القدرة الإنتاجية.',
      },
      investigation: {
        employeeName: 'نورة بنت سالم الزدجالية',
        employeeDate: '2025-02-22 10:30',
        employeeRecommendation: 'موافقة',
        employeeNotes: 'تم مراجعة كافة المستندات والتقارير الطبية الواردة من وزارة الصحة. الحالة واضحة ومستوفية للشروط. أوصي بالإحالة للمؤسسة الصحية المرخصة لتقييم مدى تأثير الحالة على الكفاءة المهنية.',
        headName: 'بدر بن خميس العبري',
        headDate: '2025-02-28 09:00',
        headDecision: 'اعتماد وإحالة',
        headNotes: 'اعتمدت التوصية. سيتم التوجيه للمقرر لجدولة الجلسة.',
      },
      sickLeavePeriods: [
        { from: '2024-08-25', to: '2024-09-23', days: 30, status: 'معتمدة', addedBy: 'مريم بنت سيف الكيومية', addedDate: '2024-08-26', note: 'فترة إجازة مرضية بسبب غسيل الكلى الدوري' },
      ],
      attachments: [
        { id: 'com404-1', type: 'تقرير طبي مثبت للمرض المستديم', name: 'تقرير_كلوي_404.pdf', uploadDate: '2025-02-20', uploadedBy: 'نواف بن سعيد الحراصي', role: 'العامل', size: '2.4 MB', icon: 'pdf' },
        { id: 'com404-2', type: 'نتائج فحوصات مخبرية', name: 'فحوصات_404.pdf', uploadDate: '2025-02-20', uploadedBy: 'نواف بن سعيد الحراصي', role: 'العامل', size: '0.9 MB', icon: 'pdf' },
      ],
      notes: [],
      referral: { institution: 'مستشفى الأمل التخصصي — السيب (رقم الترخيص: LIC-INST-2024-0034)', rapporteur: 'د. سيف بن حمد المسكري', referralDate: '2025-03-01' },
      session: null, committeeDecision: null, disbursement: null,
      timeline: [
        { action: 'استلام التشخيص من وزارة الصحة', actor: 'وزارة الصحة', role: 'آلي', time: '2024-07-15 08:00', fromStatus: '', toStatus: 'تم استلام التشخيص', note: '', type: 'default' },
        { action: 'تقديم الطلب', actor: 'نواف بن سعيد الحراصي', role: 'العامل', time: '2025-02-20 09:00', fromStatus: 'تم استلام التشخيص', toStatus: 'قيد المراجعة', note: '', type: 'default' },
        { action: 'توصية الموظف بالموافقة', actor: 'نورة بنت سالم الزدجالية', role: 'موظف قسم الإعاقة والأمراض المستديمة', time: '2025-02-22 10:30', fromStatus: 'قيد المراجعة', toStatus: 'بانتظار اعتماد رئيس القسم', note: 'موافقة وإحالة', type: 'success' },
        { action: 'اعتماد وإحالة للجان الطبية', actor: 'بدر بن خميس العبري', role: 'رئيس قسم الإعاقة والأمراض المستديمة', time: '2025-02-28 09:00', fromStatus: 'بانتظار اعتماد رئيس القسم', toStatus: 'بانتظار مراجعة موظف قسم اللجان الطبية', note: '', type: 'success' },
        { action: 'موافقة موظف اللجان على الإحالة', actor: 'سعاد بنت أحمد الريامية', role: 'موظف قسم اللجان الطبية', time: '2025-03-01 13:00', fromStatus: 'بانتظار مراجعة موظف قسم اللجان الطبية', toStatus: 'تم الموافقة على العرض على المؤسسات الصحية المرخصة — بانتظار إحالة المقرر', note: 'مستشفى الأمل التخصصي — السيب', type: 'success' },
      ],
      assignedTo: 'سعاد بنت أحمد الريامية',
      checkedOutBy: 'سعاد بنت أحمد الريامية',
    },
    {
      ...
      type: 'إعاقة',
      subtype: 'إعاقة سمعية',
      status: 'تم جدولة جلسة للعرض على المؤسسة الصحية المرخصة',
      submitDate: '2025-02-15',
      lastUpdate: '2025-03-10 14:00',
      applicant: { name: 'أسماء بنت راشد الكيومية', civil: '9077889900', role: 'العامل / المؤمن عليه / المواطن', phone: '96897788990', email: 'asmaa.k@mail.com' },
      insured: { name: 'أسماء بنت راشد الكيومية', civil: '9077889900', insurance: 'IN-20170077889', dob: '1979-09-25', gender: 'أنثى', nationality: 'عُمانية', insuranceStatus: 'نشط', regDate: '2017-01-01', subType: 'إلزامي' },
      employer: { name: 'وزارة التربية والتعليم', cr: '0000001', establishment: 'EST-GOVT-001', jobTitle: 'معلمة', joinDate: '2017-01-01', location: 'مسقط — بوشر' },
      card: { number: 'DIS-CARD-0044556', status: 'سارية', activationDate: '2020-04-10', expiryDate: '2025-04-09', typeSD: 'إعاقة سمعية تامة', typeMOH: 'فقدان سمع كلي مكتسب', provenDate: '2019-12-20', lastCheck: '2025-03-01' },
      investigation: {
        employeeName: 'نورة بنت سالم الزدجالية',
        employeeDate: '2025-02-17 09:00',
        employeeRecommendation: 'موافقة',
        employeeNotes: 'الطلب مكتمل وبطاقة الإعاقة سارية. التشخيص مؤكد بفقدان السمع الكلي. أوصي بالإحالة للمؤسسة الصحية المرخصة للتقييم.',
        headName: 'بدر بن خميس العبري',
        headDate: '2025-02-20 10:00',
        headDecision: 'اعتماد وإحالة',
        headNotes: 'الحالة واضحة. اعتمدت التوصية وأحلت للجان الطبية.',
      },
      sickLeavePeriods: [],
      referral: { institution: 'مستشفى النور التخصصي — مسقط (رقم الترخيص: LIC-INST-2024-0067)', rapporteur: 'د. سيف بن حمد المسكري', referralDate: '2025-02-25' },
      session: { date: '2025-03-20', time: '10:00', location: 'مستشفى النور التخصصي — قاعة الاجتماعات A' },
      committeeDecision: null, disbursement: null,
      attachments: [
        { id: 'com405-1', type: 'صورة بطاقة الإعاقة', name: 'بطاقة_اعاقة_405.pdf', uploadDate: '2025-02-15', uploadedBy: 'أسماء بنت راشد الكيومية', role: 'العامل', size: '0.8 MB', icon: 'pdf' },
        { id: 'com405-2', type: 'تقرير طبي سمعي متخصص', name: 'تقرير_سمعي_405.pdf', uploadDate: '2025-02-15', uploadedBy: 'أسماء بنت راشد الكيومية', role: 'العامل', size: '2.0 MB', icon: 'pdf' },
      ],
      notes: [],
      timeline: [
        { action: 'تم تقديم الطلب', actor: 'أسماء بنت راشد الكيومية', role: 'العامل', time: '2025-02-15 10:00', fromStatus: '', toStatus: 'قيد المراجعة', note: '', type: 'default' },
        { action: 'توصية الموظف بالموافقة', actor: 'نورة بنت سالم الزدجالية', role: 'موظف قسم الإعاقة والأمراض المستديمة', time: '2025-02-17 09:00', fromStatus: 'قيد المراجعة', toStatus: 'بانتظار اعتماد رئيس القسم', note: 'موافقة', type: 'success' },
        { action: 'اعتماد وإحالة للجان الطبية', actor: 'بدر بن خميس العبري', role: 'رئيس قسم الإعاقة والأمراض المستديمة', time: '2025-02-20 10:00', fromStatus: 'بانتظار اعتماد رئيس القسم', toStatus: 'بانتظار مراجعة موظف قسم اللجان الطبية', note: '', type: 'success' },
        { action: 'موافقة موظف اللجان على الإحالة', actor: 'سعاد بنت أحمد الريامية', role: 'موظف قسم اللجان الطبية', time: '2025-02-22 09:30', fromStatus: 'بانتظار مراجعة موظف قسم اللجان الطبية', toStatus: 'تم الموافقة على العرض على المؤسسات الصحية المرخصة — بانتظار إحالة المقرر', note: 'مستشفى النور التخصصي', type: 'success' },
        { action: 'إحالة المقرر وجدولة الجلسة', actor: 'أنس بن خلفان الجابري', role: 'مقرر المؤسسة الصحية المرخصة', time: '2025-03-10 14:00', fromStatus: 'تم الموافقة على العرض', toStatus: 'تم جدولة جلسة للعرض على المؤسسة الصحية المرخصة', note: 'الجلسة بتاريخ 20 مارس 2025 — الساعة 10:00 صباحاً', type: 'success' },
      ],
      assignedTo: 'سعاد بنت أحمد الريامية',
      checkedOutBy: 'سعاد بنت أحمد الريامية',
    },
  ...
  chronicIncoming: [
    ...
    },
    {
      ...
      assignedTo: 'نورة بنت سالم الزدجالية',
      checkedOutBy: 'نورة بنت سالم الزدجالية',
      applicantRole: 'العامل / المؤمن عليه / المواطن',
      applicantPhone: '96891234567',
      applicantPhone1: '96891234567',
      applicantPhone2: '96891234568',
      applicantEmail: 'saeed.habsi@mail.com',
      applicantRegion: 'محافظة الداخلية',
      applicantWilayat: 'نزوى',
      applicantCountry: 'سلطنة عُمان',
      applicantCivilExpiry: '2031-01-31',
      insuranceNo: 'IN-20180090123',
      insuranceStatus: 'نشط',
      insuranceRegDate: '2018-01-01',
      insuranceSubType: 'إلزامي',
      insuranceType: 'تأمين العاملين في القطاع الخاص',
      insuranceSchemeCategory: 'داخل السلطنة - القطاع الخاص',
      otherBenefits: 'لا يوجد',
      employerName: 'شركة الوسطى للخدمات الصناعية',
      employerCr: '5588991',
      employerJoinDate: '2018-01-01',
    },
    {
      refId: 'CHR-IN-2025-00092',
      applicantName: 'راشد بن ناصر الغافري',
      civil: '9015566778',
      hospital: 'مستشفى خولة — مسقط',
      diagnosis: 'التصلب المتعدد',
      detailedDiagnosis: 'تصلب متعدد انتكاسي مع ضعف حركي تدريجي في الأطراف السفلية',
      permanentDiseaseReport: 'تفيد التقارير الطبية بثبوت حالة التصلب المتعدد بصورة مزمنة مع نوبات متكررة وتأثر وظيفي تدريجي. الحالة تتطلب متابعة علاجية تخصصية مستمرة وتأهيل وظيفي دوري، وتندرج ضمن الأمراض المستديمة المثبتة طبياً.',
      provenDate: '2025-01-12',
      visitDateTime: '2025-01-12 09:20',
      doctor: 'د. خالد بن سالم الهنائي',
      expectedPath: 'مسار مباشر',
      severityDate: '2025-01-10',
      uniqueRequestId: 'MOH-CHR-2025-00092',
      chronicDisease: 'التصلب المتعدد',
      affectedSystem: 'الجهاز العصبي',
      severityIndex: 'MSI: 3/5 — Treatment Burden: مرتفع',
      firstRequestRef: null,
      overallCondition: null,
      hasRequest: true,
      requestId: 'CHR-2025-000157',
      requestSubmitDate: '2025-01-14',
      requestLastUpdate: '2025-01-18 10:00',
      requestStatus: 'بانتظار مراجعة رئيس قسم الإعاقة والأمراض المستديمة',
      assignedTo: 'بدر بن خميس العبري',
      checkedOutBy: 'بدر بن خميس العبري',
      applicantRole: 'العامل / المؤمن عليه / المواطن',
      applicantPhone: '96895566778',
      applicantPhone1: '96895566778',
      applicantPhone2: '96895566779',
      applicantEmail: 'rashid.ghafri@mail.com',
      applicantRegion: 'محافظة مسقط',
      applicantWilayat: 'بوشر',
      applicantCountry: 'سلطنة عُمان',
      applicantCivilExpiry: '2030-08-15',
      insuranceNo: 'IN-20170044566',
      insuranceStatus: 'نشط',
      insuranceRegDate: '2017-09-01',
      insuranceSubType: 'إلزامي',
      insuranceType: 'تأمين العاملين في القطاع الخاص',
      insuranceSchemeCategory: 'داخل السلطنة - القطاع الخاص',
      otherBenefits: 'لا يوجد',
      employerName: 'شركة الجسر الحديث للمقاولات',
      employerCr: '6677882',
      employerJoinDate: '2017-09-01',
    },
  ],
