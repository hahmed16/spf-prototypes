  ...
  roles: {
    ...
    'fund-staff': {
      ...
      sidebar: [
        ...
        { label: 'طلب حظر جديد', page: 'ban-request-new', icon: 'lock', badge: null },
        { label: 'طلب فك حظر', page: 'lift-ban-request-new', icon: 'unlock', badge: null },
      ]
    },
    ...
    'employer': {
      ...
      sidebar: [
        ...
        { label: 'قرارات الحظر', page: 'ban-cases-list', icon: 'lock', badge: null },
    ...
    'field-inspector': {
      ...
      sidebar: [
        ...
        { label: 'تحليل بيانات العامل', page: 'worker-analysis', icon: 'chart', badge: null },
        { label: 'تحليل بيانات صاحب العمل', page: 'employer-analysis', icon: 'building', badge: null },
        { label: 'الأثر المالي', page: 'financial-impact', icon: 'chart', badge: null },
        { label: 'السجل الزمني', page: 'timeline', icon: 'clock', badge: null },
        { label: 'طلبات الحظر وفك الحظر', page: 'ban-cases-list', icon: 'lock', badge: null },
        { label: 'قائمة التقارير', page: 'reports-list', icon: 'file', badge: null },
        { label: 'طلب حظر جديد', page: 'ban-request-new', icon: 'lock', badge: null },
    ...
    'inspection-director': {
      ...
      sidebar: [
        ...
        { label: 'اعتمادات المدير', page: 'director-approvals', icon: 'pen', badge: null },
        { label: 'تقرير أداء الموظفين', page: 'staff-performance', icon: 'chart', badge: null },
        { label: 'تحليل بيانات العامل', page: 'worker-analysis', icon: 'chart', badge: null },
        { label: 'تحليل بيانات صاحب العمل', page: 'employer-analysis', icon: 'building', badge: null },
        { label: 'الأثر المالي', page: 'financial-impact', icon: 'chart', badge: null },
        { label: 'السجل الزمني', page: 'timeline', icon: 'clock', badge: null },
